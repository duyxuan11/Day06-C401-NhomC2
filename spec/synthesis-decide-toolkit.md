...
```text
Dựa trên việc du khách gặp điểm gãy khi kế hoạch bị vỡ đột xuất do mưa bão/bảo trì và sự phức tạp của giao diện lập lịch trình,
nhóm sẽ build tính năng đề xuất lịch trình vi mô 1-2 tiếng (Micro-Itinerary Conversational Card) kích hoạt bằng quét mã QR định vị tại chỗ,
cho du khách tham quan công viên phức hợp (gia đình có trẻ nhỏ/người già, nhóm bạn trẻ),
để giải quyết điểm đau di chuyển lòng vòng mệt mỏi, tốn thời gian xếp hàng vô ích và thiếu thông tin trò chơi,
bằng cách AI đề xuất gợi ý lịch trình ngắn hạn (1-2 tiếng) kèm nút chọn nhanh, tự động đối soát thông tin trò chơi,
và sẽ test failure path khi thời tiết đổ mưa bão đột ngột hoặc trò chơi đề xuất đang trong trạng thái bảo trì/quá tải hàng đợi.
```
...
- Ứng dụng di động cài đặt (Native iOS/Android App).
