...
| **Tạ Duy Xuân**<br>(2A202600970) | **Đảm bảo chất lượng & Demo**: Quản trị chạy script kiểm thử tự động, quay video demo sản phẩm dài 3 phút, soạn kịch bản thuyết trình bảo vệ các quyết định sản phẩm trước lớp. | File slide thuyết trình, video demo và tệp báo cáo chạy đánh giá trong thư mục `codebase/runs`. |
