...
Tệp [test_scenarios.json](file:///c:/Users/Administrator/Day06-C401-NhomC2/codebase/mock-data/test_scenarios.json) định nghĩa 6 test case cụ thể ứng với các đường đi của trải nghiệm:
...
6. `scenario_06_realtime_weather`: Kiểm thử khả năng hệ thống tự động kết nối API Open-Meteo để lấy thời tiết thực tế khi không có tham số override.
